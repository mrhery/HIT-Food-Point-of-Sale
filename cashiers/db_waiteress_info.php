...
<div align="center">
        <strong style="font-size:25px; padding: 5px;">User Dashboard</strong> 
            ...
            <strong>Time:</strong> <?= date("H:i:s",time() + 54000) ?>
            	...
            	<hr /></div>
	<h2>Waiteress Info</h2>



<div align="center">
	<div align="right" id="rb_menu" style="margin-right:25px;"><a href="add_user.php?user_section=waitress">Register New Waitress</a></div>
    <br />
	<table class="tbl" width="80%" style="border:#F30 groove; border-top-right-radius:10px; border-top-left-radius:10px;">
        ...
        <tr>
            ...
            <td align="center"><div id="delete_button"><a href="del_user.php?user_id=<?= $rquser["user_id"] ?>&user_section=waitress" >
