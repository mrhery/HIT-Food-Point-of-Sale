...
if(isset($_GET["table_no"], $_GET["item_id"], $_GET["type_name"])){
	...
	if($npromo == 0){
		...
		/*$ibill = mysqli_query($conn, "INSERT INTO bills(bill_no, bill_date, bill_time, bill_month, bill_year, bill_total, bill_waiteress, bill_cashier) VALUES('{$bill_no}', '{$bill_date}', '{$bill_time}', '{$bill_month}', '{$bill_year}', '{$item_price}', '{$user}', '{$user}') ");*/
